...
#define PEN_DOWN_ANGLE       (130)  // Some steppers don't like 0 degrees
...
//#define MOTHERBOARD 2 // AZTEEG X1
#define MOTHERBOARD 3// RAMPS
...
#define MOTOR_0_LIMIT_PIN  (-1)
#define MOTOR_1_LIMIT_PIN  (-1)
...
#define ADDR_LIMIT_TOP   (ADDR_SPOOL_DIA2+4)       // address of limit top width of machine(float - 4 bytes)
#define ADDR_LIMIT_BOT   (ADDR_LIMIT_TOP+4)        // address of limit bottom of machine(float - 4 bytes)
#define ADDR_LIMIT_R     (ADDR_LIMIT_BOT+4)		   // address of limit right of machine(float - 4 bytes)
#define ADDR_LIMIT_L     (ADDR_LIMIT_R+4)		   // address of limit left of machine(float - 4 bytes)
