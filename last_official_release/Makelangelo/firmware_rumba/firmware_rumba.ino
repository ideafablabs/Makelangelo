...
float limit_top = -40.64;  // distance to top of drawing area.
float limit_bottom = 40.64;  // Distance to bottom of drawing area.
float limit_right = 29.845;  // Distance to right of drawing area.
float limit_left = -29.845;  // Distance to left of drawing area.
