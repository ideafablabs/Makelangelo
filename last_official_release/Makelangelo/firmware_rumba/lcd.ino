...
void LCD_update() {
  ...
  if(sd_printing_now && (digitalRead(KILL_PIN) == LOW))
  {
    LCD_stop();
  }
...
void LCD_status_menu() {
  MENU_START
    ...
    float d2=laststep[1];
#if 0
	Serial.print("l[0] = "); Serial.print(laststep[0]);
	Serial.print("l[1] = "); Serial.print(laststep[1]);
    ...
    //lcd.clear();
    lcd.setCursor( 0, 0);  lcd.print('X');  LCD_print_float(posx * 10);
    lcd.setCursor(10, 0);  lcd.print('Y');  LCD_print_float(posy * 10);
